...
const IssueDetails = () => {
  ...
  const handlerUpdateIssueStatu = (status) => {
          ...
          <div>
            ...
            <div className="mt-5">
              ...
              <Tabs defaultValue="comments" className="w-[400px]">
                ...
                <TabsContent value="all">Aaaa</TabsContent>
                ...
                <TabsContent value="history">Aaaa</TabsContent>
              </Tabs>
            </div>
          </div>
        </ScrollArea>
        <div className="w-full lg:w-[30%] space-y-2">
          <Select onValueChange={handlerUpdateIssueStatu}>
